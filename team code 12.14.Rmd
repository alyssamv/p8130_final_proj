...
glm.fit <- glm(target_death_rate ~ log_ann_count + incidence_rate + med_income + median_age_male + percent_married + pct_bach_deg25_over + pct_black_bin + pct_other_race_bin + pct_private_coverage + pct_public_coverage + region, data = cancer2)


cv.err <- cv.glm(cancer2, glm.fit)
...
newsummary(lm(target_death_rate ~ log_ann_count + incidence_rate + med_income + median_age_male + percent_married + pct_bach_deg25_over + pct_black_bin + pct_other_race_bin + pct_private_coverage + pct_public_coverage + region, data = cancer2))
