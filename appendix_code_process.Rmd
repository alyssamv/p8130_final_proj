...
When we test our original selected variables with a Lasso model, we find the same parameters are downweighted/removed.
...
final.model = lm(target_death_rate ~ log_ann_count + incidence_rate + poverty_percent + 
...
kfold_cv = lapply(1:10, function(i){
  ...
  model_caret <- train((target_death_rate ~ log_ann_count + incidence_rate + poverty_percent + 
